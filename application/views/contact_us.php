...
<body class="stretched">
    ...
    <div id="side-panel" class="bg-white">
        ...
        <div id="side-panel-trigger-close" class="side-panel-trigger"><a href="demo-furniture-contact.html#"><i
        ...
        <div class="side-panel-wrap">
            <div class="top-cart d-flex flex-column h-100">
                ...
                <div class="top-cart-items">
                    ...
                    <div class="top-cart-item">
                        <div class="top-cart-item-image border-0">
                            <a href="demo-furniture-contact.html#"><img src="demos/furniture/images/cart/1.jpg"
                                    alt="Cart Image 1" /></a>
                        </div>
                        <div class="top-cart-item-desc">
                            <div class="top-cart-item-desc-title">
                                <a href="demo-furniture-contact.html#" class="fw-medium">Blue Sofa for Dining Room</a>
                                <span class="top-cart-item-price d-block"><del>$29.99</del> $19.99</span>
                                <div class="d-flex mt-2">
                                    <a href="demo-furniture-contact.html#"
                                        class="fw-normal text-black-50 text-smaller"><u>Edit</u></a>
                                    <a href="demo-furniture-contact.html#"
                                        class="fw-normal text-black-50 text-smaller ms-3"><u>Remove</u></a>
                                </div>
                            </div>
                    ...
                    <div class="top-cart-item">
                        <div class="top-cart-item-image border-0">
                            <a href="demo-furniture-contact.html#"><img src="demos/furniture/images/cart/2.jpg"
                                    alt="Cart Image 2" /></a>
                        </div>
                        <div class="top-cart-item-desc">
                            <div class="top-cart-item-desc-title">
                                <a href="demo-furniture-contact.html#" class="fw-medium">Ceilling Light for Office</a>
                ...
                <div class="top-cart-action flex-column align-items-stretch">
                    ...
                    <a href="demo-furniture-contact.html#" class="button btn-block text-center m-0 fw-normal"><i
                                        ...
                                        <p class="m-0" style="color:black;">
                                            <?php 
                                                if(!empty($contact_us_data))
                                                {
                                                    foreach($contact_us_data as $row)
                                                    {
                                                        echo $row['nep_address'];
                                                    }
                                                }  
                                            ?>
                                        </p>
                                        <p class="m-0" style="color:black;margin-top:20px;">
                                            <?php 
                                                if(!empty($contact_us_data))
                                                {
                                                    foreach($contact_us_data as $row)
